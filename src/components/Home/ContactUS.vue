    ...
    <div class="max-w-2xl mx-auto">
      <div class="mb-12 relative flex justify-center">
        <div class="bg-[#E0E0E0] dark:bg-[#272727] -skew-x-12 inline-block">
          ...
          <div
            class="absolute bottom-0 right-0 w-full h-1 bg-[#E25353] dark:bg-[#9c78ff]"
          />
        </div>
      </div>
      ...
      <form class="space-y-6" @submit.prevent="submitForm">
        ...
        <button
          type="submit"
          class="w-full py-3 px-4 border border-transparent rounded-md shadow-sm text-base font-medium text-white bg-[#E99797] dark:bg-[#b485ff] hover:bg-[#e57f7f] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#E99797] dark:hover:bg-[#cfa6ff] dark:focus:ring-offset-gray-800"
        >
          提交
        </button>
      </form>
