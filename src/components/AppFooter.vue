        ...
        <div class="space-y-4">
          ...
          <div class="flex space-x-6">
            ...
            >
              ...
              >
                <i class="fab fa-facebook-f text-xl text-gray-700 group-hover:text-white transition-colors duration-300" />
              </div>
            </a>
            <a
              href="https://discord.gg/sHUv6TK2As"
              target="_blank"
              class="group"
            >
              <div
            ...
            >
              <div
                class="w-12 h-12 bg-gray-300 rounded-full flex items-center justify-center group-hover:bg-gray-400 transition-colors duration-300"
              >
                <i class="fab fa-instagram text-xl text-gray-700 group-hover:text-white transition-colors duration-300" />
              </div>
            </a>
          </div>
        </div>
